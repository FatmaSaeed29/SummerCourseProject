...
dropArea.addEventListener("dragleave", ()=>{
  ...
  dragText.textContent = "Drop to Upload File or Click Here";
});
...
$(document).ready(function () { 
  ...
  $("#repeatDivBtn").click(function () { 
   ...
   $("#repeatDiv" + '_' + $newid).append('<div class="input-group-append"><i class="far fa-times ml-2 mt-2 removeDivBtn"  data-id="repeatDiv'+'_'+ $newid+'"></i></div>'); 
   $newid++; 
